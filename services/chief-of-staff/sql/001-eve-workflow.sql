-- eve-saga: @workflow/world-postgres@5.0.0-beta.32 schema (extracted for manual box deploy)
--
...
-- equivalent, meant to be applied once by hand before the box's eve-saga container starts.
--
...
-- concurrent DDL. Not a concern for a single eve-saga instance; worth another look if the box
-- ever runs eve-saga as more than one replica.)
--
